...
dorbell_dash_db = os.environ.get('DOORBELL_DASH_DB')

# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/1.10/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = '9r$1fx4f#yaqwn=x+ea7umzoo=$v%j#165*^3v$&ku^o0tn35j'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost","10.0.0.111", "127.0.0.1"]
...
ROOT_URLCONF = 'doorbell_dash_project.urls'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'DOORBELL_DASH_DB'),
    }
}
